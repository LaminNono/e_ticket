...
// Fetch user bookings
$stmt = $pdo->prepare("SELECT b.*, r.origin, r.destination, r.depart_time, r.arrival_time, r.price,
        ...
        <div class="row">
            ...
            <div class="col-md-10 content">
                <div class="top-section text-center">
                    ...
                    <p>If you need help with your booking or payment, please contact
                        <strong>support@eticket-myanmar.com</strong>.
                    </p>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($b['origin']) ?> ➔ <?= htmlspecialchars($b['destination']) ?>
                                </td>
                    ...
                    <form method="post" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control"
                                value="<?= htmlspecialchars($userInfo['name']) ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control" value="<?= htmlspecialchars($userInfo['email']) ?>"
                                disabled>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">NRC / Passport No.</label>
                            <input type="text" name="nrc" class="form-control"
                                value="<?= htmlspecialchars($userInfo['nrc']) ?>">
                        </div>
                        <div class="col-md-6">
