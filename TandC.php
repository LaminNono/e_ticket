...
<body>
    ...
    <section class="terms-section">
        <div class="container">
            ...
            <p>Welcome to E-ticket Myanmar. By using our services, you agree to be bound by the following terms and
                conditions. Please read them carefully before making a booking.</p>

            <h5>1. Ticket Booking & Payments</h5>
            <p>All bookings must be confirmed via our online platform. Payments can be made through available digital
                payment methods. Once payment is made, a digital ticket will be issued.</p>

            <h5>2. Cancellations & Refunds</h5>
            <p>Cancellations must be made at least 24 hours before departure. Refunds (if eligible) will be processed
                through the same payment method after deducting cancellation charges.</p>

            <h5>3. Travel Responsibilities</h5>
            <p>Passengers must arrive at the bus station at least 30 minutes before departure. Failure to arrive on time
                may result in a missed trip without refund.</p>

            <h5>4. Privacy Policy</h5>
            <p>Your personal information is collected solely for booking and service improvement purposes. We do not
                share or sell customer data with third parties without consent.</p>

            <h5>5. Changes to Service</h5>
            <p>E-ticket Myanmar reserves the right to modify routes, schedules, and pricing without prior notice in case
                of operational or legal requirements.</p>

            <h5>6. Customer Support</h5>
            <p>For any inquiries or issues, you may contact our support team via email or phone. We aim to respond
                within 24 hours.</p>

            <p class="mt-4">By continuing to use our services, you acknowledge that you have read and agree to abide by
