...
<head>
  <meta charset="UTF-8">
  <title>Affiliates - E-ticket Myanmar</title>
    ...
    <div class="container">
      <div class="row align-items-center" data-aos="fade-up">
        <div class="col-md-12">
          ...
          <p>
            Join the E-ticket Myanmar Affiliate Program and earn by promoting the future of smart travel! Whether you're a travel blogger, social media influencer, or local partner, our affiliate platform provides you with tools to earn commission for every booking made through your referral.
          </p>
          <p>
            Our affiliates enjoy competitive rates, real-time tracking, monthly payouts, and dedicated support. We believe in growing together and offering convenience to travelers while helping our partners succeed.
          </p>
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col-md-12 highlight-box text-center" data-aos="fade-up">
          <h4>“Partner with us & grow with Myanmar’s digital travel revolution.”</h4>
          <p class="mt-3">Sign up today and let's connect your audience with seamless ticketing solutions.</p>
        </div>
      </div>
    </div>
  </section>
